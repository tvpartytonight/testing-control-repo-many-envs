...
mod 'yo61/logrotate',       git: 'https://github.com/yo61/puppet-logrotate',           tag: '1.4.0'
mod 'ghoneycutt/logrotate', git: 'https://github.com/ghoneycutt/puppet-module-ssh',    tag: '3.36.0'
mod 'ghoneycutt/pam',       git: 'https://github.com/ghoneycutt/puppet-module-pam',    tag: '2.22.0'
mod 'saz/rsyslog',          git: 'https://github.com/saz/puppet-rsyslog',              tag: '3.5.1'


# Advanced linux host management
mod 'garethr/docker', git: 'https://github.com/garethr/garethr-docker', tag: '5.2.0'
mod 'vshn/gitlab',    git: 'https://github.com/vshn/puppet-gitlab',     tag: '1.8.0'
...
mod 'saz/memcached',               git: 'https://github.com/saz/puppet-memcached',             tag: '2.8.1'
...
mod 'jfryman/nginx',         git: 'http://github.com/jfryman/puppet-nginx',              tag: '0.3.0'
mod 'puppetlabs/tomcat',     git: 'https://github.com/puppetlabs/puppetlabs-tomcat',     tag: '1.5.0'

mod 'rtyler/jenkins',        git: 'https://github.com/jenkinsci/puppet-jenkins',         tag: '1.6.1'
mod 'sensu/sensu',           git: 'https://github.com/sensu/sensu-puppet',               tag: '2.1.0'
mod 'bfraser/grafana',       git: 'https://github.com/bfraser/puppet-grafana',           tag: '2.5.0'
...
mod 'badgerious/windows_env',    git: 'https://github.com/badgerious/puppet-windows-env',       tag: '2.2.2'
mod 'puppet/windows_firewall',   git: 'https://github.com/voxpupuli/puppet-windows_firewall',   tag: '1.0.3'
mod 'puppet/windows_autoupdate', git: 'https://github.com/voxpupuli/puppet-windows_autoupdate', tag: '1.1.0'
mod 'puppet/dotnet',             git: 'https://github.com/puppet-community/puppet-dotnet',      tag: '1.0.2'
mod 'puppet/windowsfeature',     git: 'https://github.com/puppet-community/windowsfeature',     tag: '1.1.0'
...
mod 'puppet/iis',                   git: 'https://github.com/voxpupuli/puppet-iis',                tag: '2.0.2'
mod 'puppet/graphite_powershell',   git: 'https://github.com/voxpupuli/puppet-windows_eventlog',   tag: '1.0.1'
